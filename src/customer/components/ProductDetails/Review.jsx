        ...
        <div className="justify-center flex-1 max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                <div className="p-6 mb-6 bg-gray-50 dark:bg-gray-900">
                    ...
                    <div className="items-center ">
                        <div href="#" className="px-4 py-2 text-xs text-gray-100 bg-blue-500 hover:bg-blue-600 ">
                            View all reviews</div>
                    </div>
                </div>
                        ...
                        <div className="block">
                            <div className="w-auto px-2 pb-2 ">
                                <div className="font-medium">
                                    <div href="#" className="text-lg font-semibold dark:text-gray-400 hover:underline">
