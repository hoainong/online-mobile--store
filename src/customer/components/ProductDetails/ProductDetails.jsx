        ...
        <div className="flex flex-wrap -mx-4">
          ...
          <div className="w-full px-4 md:w-1/2">
            <div className="lg:pl-20">
              <div className="mb-8">
                <h2 className="max-w-xl mb-6 text-2xl font-bold dark:text-gray-400 md:text-4xl">{product?.name}
                {isProductState && isDiscount &&  (
                <span className='ml-2 bg-red-700 text-white p-1 rounded-md  '>
                  sale
                </span> )}</h2>
                <p className="inline-block mb-6 text-4xl font-bold text-gray-700 dark:text-gray-400">
                  <span>{product?.newPrice?.toLocaleString('vi-VN', { style: 'currency', currency: 'VND' })}</span>
              ...
              <h2 className="w-16 pb-1 mb-4 text-2xl font-bold border-b border-blue-300 dark:text-gray-400 dark:border-gray-600">
                  ...
                  <span className="capitalize whitespace-nowrap">{product.color}</span>
                </h2>
              </div>
              <div className="mb-8">
                <h2 className="w-16 pb-1 mb-4 text-xl font-semibold border-b border-blue-300 dark:border-gray-600 dark:text-gray-400">RAM
