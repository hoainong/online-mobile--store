            ...
            <div className="w-full px-2 lg:px-4 lg:w-2/4 lg:mb-0 lg:py-0 py-7">
              <div className="px-6 text-left">
                ...
                <form onSubmit={handleLogin} className="mt-6">
                  ...
                  <div className="mt-6">
                    <label htmlFor="" className="pb-4 mb-2 text-gray-700 dark:text-gray-300">
                      Password:
                    </label>
                  ...
                  <div className="mt-4 text-right">
                    <a href="#" className="text-sm font-semibold text-blue-700 dark:text-blue-300 hover:underline">
                      Forgot password?
                    </a>
                  </div>
                  <button
