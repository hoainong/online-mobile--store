                            ...
                            <div className="absolute left-0 z-10 top-10 lg:top-40">
                                <div className="p-14">
                                    ...
                                    <button
                                        ...
                                        type="submit">Getting started</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="w-full px-2 lg:px-4 lg:w-2/4 lg:mb-0 lg:py-0 py-7">
                            <div className="px-6 text-left">
                                ...
                                <form action="" onSubmit={handleRegister} className="mt-6">
                                    <div>
                                        <label htmlFor="" className="text-gray-700 dark:text-gray-300">Email:</label>
                                        <input type="email"
                                            value={email}
                                    ...
                                    <div>
                                        <label htmlFor="" className="text-gray-700 dark:text-gray-300">Full name:</label>
                                        <input type="text"
                                            value={fullName}
                                    ...
                                    <div>
                                        <label htmlFor="" className="text-gray-700 dark:text-gray-300">Confirm Password:</label>
                                        <input type="password"
                                            value={confirmPassword}
                                            onChange={(e) => setConfirmPassword(e.target.value)}
                                            className="w-full px-4 py-3 mt-2 bg-white rounded-lg dark:text-gray-100 dark:bg-gray-800 dark:border dark:border-gray-800"
                                            name="" placeholder="Enter your confirm password" />
                                    </div>
