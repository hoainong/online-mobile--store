                    ...
                    <div className="px-6 text-left">
                        ...
                        <form action="" className="mt-6">
                            ...
                            <div className="mt-6">
                                <div>
                                    <label for=""
                                        className="pb-4 mb-2 text-gray-700 dark:text-gray-300">Password:</label>
                                    <div className="relative flex items-center mt-2">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            className="absolute right-0 mr-3 bi bi-eye-slash dark:text-gray-50" fill="currentColor"
                                           viewBox="0 0 16 16">
                                            <path
